...
|------|-------------|----------|
| **Long-form** | `call.insideraccidentlawyers.com/` or `…/los-angeles-car-accident-lawyer/` (full page) | Authority, SEO, “main” experience. |
| **Minim** (this repo) | `call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/` (high-contrast, super-long keyword URL) | Paid, testing, or dedicated campaign LPs. |
...
3. **Find/replace in the codebase**  
   Replace `los-angeles-car-accident-lawyer` with your new slug in:
...
Result: super-long keyword URLs like `…/los-angeles-car-accident-lawyer/`, `…/los-angeles-motorcycle-accident-lawyer/`, one minim LP per path.
...
You can have long-form and minim on the **same** path only if you choose one as canonical (e.g. long-form at `/los-angeles-car-accident-lawyer/`, minim at `/los-angeles-car-accident-lawyer/min/` or vice versa). See README “What if long-form performs better?” for options.
...
- **Option A – One URL per topic**  
  ...
  Example: long-form wins for car accident → serve long-form at `…/los-angeles-car-accident-lawyer/`, 301 the old minim URL to it (or remove minim from that path).

- **Option B – Keep both, send traffic to the winner**  
  e.g. Minim at `…/los-angeles-car-accident-lawyer/`, long-form at `…/los-angeles-car-accident-lawyer/full/`.  
...
|-----------------|------------|----------------------|
| Car accident | `/los-angeles-car-accident-lawyer/` | `/` or `/los-angeles-car-accident-lawyer/` |
...
Use the same slug on both templates if you want topic parity; use a subpath (e.g. `/los-angeles-car-accident-lawyer/full/`) when you need both templates for the same topic.
