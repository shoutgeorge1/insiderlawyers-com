...
**Live site (do not replace):** [https://call.insideraccidentlawyers.com/](https://call.insideraccidentlawyers.com/)
...
1. **Keep the live site:** All production traffic stays at **https://call.insideraccidentlawyers.com/**.
...
Form actions and thank-you redirect stay pointed at the live domain (e.g. `https://call.insideraccidentlawyers.com/thank-you.html`).
