...
| **https://call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/** | **This project** – minimal high-contrast car accident LP. |
...
**Minim = super-long paths:** One path per topic, full keyword (e.g. `los-angeles-car-accident-lawyer`).  
...
|----------|-------------|
| **Same path, swap template** | You test minim at `/los-angeles-car-accident-lawyer/`. If long-form wins, replace that path with the long-form car accident page and 301 or retire the minim. One canonical URL per topic. |
| **Separate paths so both exist** | Minim at `/los-angeles-car-accident-lawyer/`, long-form at `/los-angeles-car-accident-lawyer/full/` (or base `/` for “all topics”). Send traffic to whichever converts better; no conflict. |
...
1. **Keep the live site:** All production traffic stays at **https://call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/**.
...
Form actions and thank-you redirect stay pointed at the live domain (e.g. `https://call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/thank-you.html`).

---

## Getting a new URL for this project

- **Production (canonical):** Use **https://call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/**  
  Set this up on your host (same server as call.insideraccidentlawyers.com): add a route or folder `/los-angeles-car-accident-lawyer/` that serves this repo’s `index.html` (and `styles/`, etc.), or copy the built files into that path.
...
Use the preview URL to test changes; point production traffic at **call.insideraccidentlawyers.com/los-angeles-car-accident-lawyer/** when ready.
