...
**Canonical URL for this minim LP (once configured):** [https://call.insideraccidentlawyers.com/car-accident/](https://call.insideraccidentlawyers.com/car-accident/)  
...
| **https://call.insideraccidentlawyers.com/car-accident/** | **This project** – minimal high-contrast car accident LP. |
...
**Minim = super-long paths:** One path per topic, full keyword (e.g. `car-accident`).  
...
|----------|-------------|
| **Same path, swap template** | You test minim at `/car-accident/`. If long-form wins, replace that path with the long-form car accident page and 301 or retire the minim. One canonical URL per topic. |
| **Separate paths so both exist** | Minim at `/car-accident/`, long-form at `/car-accident/full/` (or base `/` for “all topics”). Send traffic to whichever converts better; no conflict. |
